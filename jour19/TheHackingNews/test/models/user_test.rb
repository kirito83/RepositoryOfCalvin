...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(pseudo: "Pseudonyme", address: "23 champ du repos - 75000 - Paris", first_name: "ExampleFirstName", last_name: "ExampleLastName", email: "example@email.com", password: "passwordexample", password_confirmation: "passwordexample")
  end
